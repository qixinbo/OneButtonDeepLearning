...
class RestoreScratchedImage(Simple):
    ...
    def run(self, ips, imgs, para = None):
        ...
        self.app.show_img([output], ips.title+'-recovered')


class RestoreScratchedImageWithGivenScratch(Simple):
    title = 'Restore Scratched Image with Given Scratch Mask'
    note = ['rgb']
    ...
    def run(self, ips, imgs, para = None):
        ...
        mask = self.app.get_img(opt.scratch_img).img
...
plgs = [RestoreImage, RestoreScratchedImage, RestoreScratchedImageWithGivenScratch]